        ...
        <div class="container">
            <form class="form-signin" action="../../controllers/Usuario/c_incluir_usuario.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input name="nome" id="nome" placeholder="Digite seu nome" class="form-control" required/>
                    <label for="email">E-mail:</label>
                    <input name="email" id="email" placeholder="Digite seu email" class="form-control" required/>
                    ...
                    <input name="celular" id="celular" placeholder="Digite seu telefone celular" class="form-control" required/>
                </div>
